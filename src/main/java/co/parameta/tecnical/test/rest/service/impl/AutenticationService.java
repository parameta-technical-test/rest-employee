...
import co.parameta.tecnical.test.commons.util.exception.MensajePersonalizadoException;
import co.parameta.tecnical.test.commons.util.mapper.AdministratorUserMapper;
import co.parameta.tecnical.test.rest.dto.AuthResponseDTO;
import co.parameta.tecnical.test.rest.dto.RequestLoginDTO;
import co.parameta.tecnical.test.rest.repository.AdministratorUserRepository;
import co.parameta.tecnical.test.rest.service.IAutenticationService;
import co.parameta.tecnical.test.rest.util.Constants;
...
public class AutenticationService implements IAutenticationService {
    ...
    public ResponseGeneralDTO userLogin(RequestLoginDTO request) {
        ...
        response.setData(
                AuthResponseDTO.builder()
                        .token(token)
                        .tiempoExpiracion(iJwtService.getTimeRemainingMillis(token))
    ...
    public ResponseGeneralDTO userInformation(String tokenHeader) {
        ...
        try {
            ...
            response.setData(
                    AuthResponseDTO.builder()
                            .tiempoExpiracion(iJwtService.getTimeRemainingMillis(jwt))
                            .usuario(user.getEmail())
                            .build()
            );
            return response;
